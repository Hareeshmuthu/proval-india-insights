...
import CanaraVacantPlotForm from "@/components/forms/CanaraVacantPlotForm";
import CanaraVacantPlotPrintForm from "@/components/forms/CanaraVacantPlotPrintForm";
...
const SECTION_TITLES = {
  general: "I. GENERAL",
  characteristics: "II. CHARACTERISTICS OF SITE",
  valuation: "III. VALUATION",
  certificate: "IV. CERTIFICATE"
};

const CanaraVacantPlotValuation = () => {
  ...
  const handleSave = () => {
    localStorage.setItem(`canara_form_${activeSection}_${project?.projectNumber || 'draft'}`, JSON.stringify(formData));
        ...
        <main className="flex-1 overflow-y-auto p-6">
          ...
          <div className="mb-6">
            <h1 className="text-2xl font-bold text-foreground">
              {project ? `${project.customerName}'s Canara Bank Vacant Plot Valuation` : 'Canara Bank Vacant Plot Valuation Form'}
            </h1>
            <p className="text-muted-foreground">
              {project 
                ? `Project #${project.projectNumber} - Complete the form below for vacant plot valuation` 
                : 'Complete the form below for vacant plot valuation'}
            </p>
          </div>
...
export default CanaraVacantPlotValuation;
