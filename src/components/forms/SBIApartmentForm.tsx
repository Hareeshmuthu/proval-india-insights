...
const sbiFormFields = [
  {
    ...
    fields: [
      ...
      { sn: "b", label: "Date on which the valuation is made" },
      { sn: "c", label: "Date of Report" },
      ...
      { sn: "b", label: "Door No." },
      { sn: "c", label: "T. S. No. / Village" },
      { sn: "d", label: "Ward / Taluka" },
      { sn: "e", label: "Mandal / District" },
      { sn: "f", label: "Date of issue and validity of layout plan" },
      { sn: "g", label: "Approved map issuing authority" },
      { sn: "h", label: "Genuineness of the approved map verified" },
      { sn: "i", label: "Comments on authenticity of plan" },
      { sn: "7", label: "Postal address of the property" },
      { sn: "8a", label: "City / Town" },
      { sn: "b", label: "Residential Area" },
      { sn: "c", label: "Commercial Area" },
      { sn: "d", label: "Industrial Area" },
      { sn: "9a", label: "Classification of area - High / Middle / Poor" },
      { sn: "b", label: "Urban / Semi Urban / Rural" },
      ...
      { sn: "b", label: "Dimensions - South" },
      { sn: "c", label: "Dimensions - East" },
      { sn: "d", label: "Dimensions - West" },
      { sn: "e", label: "North-East Corner" },
  ...
  },
  {
    ...
    fields: [
      ...
      { sn: "b", label: "Block No." },
      { sn: "c", label: "Ward No." },
      { sn: "d", label: "Village / Municipality / Corporation" },
      { sn: "e", label: "Door No., Street / Road" },
      ...
      { sn: "11a", label: "Lift" },
      { sn: "b", label: "Protected Water Supply" },
      { sn: "c", label: "Underground Sewerage" },
      { sn: "d", label: "Car Parking" },
      { sn: "e", label: "Compound wall" },
      { sn: "f", label: "Pavement around Building" }
    ]
  },
  {
    section: "III. FLAT",
